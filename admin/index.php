...
<div class="container">
    <div class="alert text-center" style="background-color: #C0BBDE;">
        <h4 style="margin-bottom: 0px">SELAMAT DATANG DI <b> LAUNDRY Q</b></h4>
    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="panel -primary">
                        <div class="panel-heading" style="background-color: #ffd1df;">
                            <h1>
